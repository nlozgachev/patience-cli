...
export type WithIndexedPile<T extends symbol, IDX> = WithPile<T> & { index: IDX };
export type WithAutoIndexPile<T extends symbol> = WithPile<T> & WithIndexedPile<T, 'auto'>;
export type WithNoneIndexPile<T extends symbol> = WithPile<T> & WithIndexedPile<T, 'none'>;

export type AllCardLocations = TableauLocation | FoundationLocation | WasteLocation | FoundationLocationUnknownIndex;
...
export type FoundationLocationUnknownIndex = WithAutoIndexPile<typeof FOUNDATION>;
export type WasteLocation = WithNoneIndexPile<typeof WASTE>;

export type FromTableauToFoundation = FromTo<TableauLocation, FoundationLocation>;
export type FromTableauToTableau = FromTo<TableauLocation, TableauLocation>;
export type FromFoundationToTableau = FromTo<FoundationLocation, TableauLocation>;
